...
def main():
    ...
    parser.add_argument('--tracker_param', type=str, default='baseline', help='Name of parameter file.')
    parser.add_argument('--videofile', type=str, default='/home/qiuyang/Desktop/video/bell.mp4', help='path to a video file.')
