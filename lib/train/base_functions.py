...
def get_optimizer_scheduler(net, cfg):
    ...
    if train_cls:
        ...
        param_dicts = [
            ...
            #},
            {"params": [p for n, p in net.named_parameters() if "AdaptiveFusion" not in n and p.requires_grad]},
            {
                "params": [p for n, p in net.named_parameters() if "AdaptiveFusion" in n and p.requires_grad],
                "lr": cfg.TRAIN.LR * 10,
