...
def transform_got10k(tracker_name, cfg_name):
    env = env_settings()
    result_dir = '/home/qiuyang/efttrack_s1/test/tracking_results/'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--tracker_name', type=str,default='efttrack_s1', help='Name of tracking method.')
    parser.add_argument('--cfg_name', type=str, default='baseline',help='Name of config file.')
