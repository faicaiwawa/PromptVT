...
# MODEL
cfg.MODEL = edict()
cfg.MODEL.HEAD_TYPE = "CORNER_LITE_REP_v2"
cfg.MODEL.HIDDEN_DIM = 256
cfg.MODEL.HEAD_DIM = 256  # channel in the corner head
# MODEL.BACKBONE
cfg.MODEL.BACKBONE = edict()
cfg.MODEL.BACKBONE.TYPE = "RepVGG-A1"  #
...
cfg.TRAIN.VAL_EPOCH_INTERVAL = 500
...
# DATA.VAL
cfg.DATA.VAL = edict()
cfg.DATA.VAL.DATASETS_NAME = ["GOT10K_test"]
...
cfg.DATA.TEMPLATE.NUMBER = 2  # number of search frames for multiple frames training
