...
class MobileOneBlock(nn.Module):
    ...
    def __init__(self,
        ...
        if inference_mode:
            ...
            self.rbr_skip = FrozenBatchNorm2d(in_channels) \
    ...
    def _conv_bn(self,
        ...
        mod_list.add_module('conv', nn.Conv2d(in_channels=self.in_channels,
                                              ...
                                              groups=self.groups,
                                              bias=False))
        mod_list.add_module('bn', FrozenBatchNorm2d(self.out_channels))
        return mod_list
...
class MobileOne(nn.Module):
    ...
    """
    def __init__(self,
                 num_blocks_per_stage: List[int] = [2, 8, 5, 1],
                 num_classes: int = 1000,
                 width_multipliers: Optional[List[float]] = [1.5, 1.5, 2.0, 2.5],
                 inference_mode: bool = False,
                 use_se: bool = False,
                 num_conv_branches: int = 1) -> None:
        ...
        #self.stage6 = self._make_stage_stride32(int(256 * width_multipliers[2]), num_blocks_per_stage[2],
        #                               num_se_blocks=int(num_blocks_per_stage[2] // 2) if use_se else 0)
